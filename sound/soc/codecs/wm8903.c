...
#define SEQ_PR_WM8903(x)					\
	do {							\
		seq_printf(s, "0x%04X : 0x%08X %s\n",		\
			   (x), snd_soc_read(codec, (x)), (wm8903_reg_defaults[(x)] == snd_soc_read(codec, (x)))?"":"..... modified");	\
	} while (0)
				 ...
				 enum snd_soc_bias_level level)
{
	...
	case SND_SOC_BIAS_PREPARE:
		...
		reg = WM8903_VMID_TIE_ENA | WM8903_BUFIO_ENA | WM8903_VMID_IO_ENA | (WM8903_VMID_RES_50K<<WM8903_VMID_RES_SHIFT) | WM8903_VMID_BUF_ENA;
	...
	case SND_SOC_BIAS_STANDBY:
		...
		reg = snd_soc_read(codec, WM8903_VMID_CONTROL_0);
		reg &= ~(WM8903_VMID_RES_MASK);
		reg |= (WM8903_VMID_RES_250K<<WM8903_VMID_RES_SHIFT);
		snd_soc_write(codec, WM8903_VMID_CONTROL_0, reg);
		#endif
		break;
