...
/* for panic report and reset log */
#ifdef CONFIG_RESETLOG
#define IO_LOG_PHYS	0x3FF00000
#define IO_LOG_VIRT	0xFEB00000
#define IO_LOG_SIZE	SZ_1M
#endif
...
#define IO_TO_VIRT(n) ( \
	...
	IO_TO_VIRT_BETWEEN((n), IO_LOG_PHYS, IO_LOG_SIZE) ?		\
		IO_TO_VIRT_XLATE((n), IO_LOG_PHYS, IO_LOG_VIRT) :	\
	0)
#else
#define IO_TO_VIRT(n) ( \
	IO_TO_VIRT_BETWEEN((n), IO_PPSB_PHYS, IO_PPSB_SIZE) ?		\
