...
/*	CPU_DVFS("cpu", 1, 0, MHZ, 380, 380, 503, 503, 655, 655,  798,  798,  902,  902,  960,  1000),
	...
	CPU_DVFS("cpu", 1, 0, MHZ, 216,  312,  456,  608,  760,  816,  912,  1000, 1232, 1336, 1424, 1472),
	CPU_DVFS("cpu", 1, 1, MHZ, 216,  312,  456,  608,  760,  816,  912,  1000, 1232, 1336, 1424, 1472),
	CPU_DVFS("cpu", 1, 2, MHZ, 816,  912, 1000, 1232, 1336, 1424, 1472),
	CPU_DVFS("cpu", 1, 3, MHZ, 912, 1000, 1232, 1336, 1424, 1472),
