...
// definition of g-sensor rotation angle according to screen rotation angle, must be sync with system.prop(ro.sf.hwrotation)
// valid values are: 0,90,180,270
#define SENSORS_KXTF9_HWROTATION        0
