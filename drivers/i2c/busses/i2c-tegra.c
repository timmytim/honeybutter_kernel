...
#define I2C_I2C_CMD_ADDR1 0x008
#define I2C_I2C_CMD_DATA1 0x00C
#define I2C_I2C_CMD_DATA2 0x010
#define I2C_I2C_STATUS    0x01C
#define I2C_I2C_SL_CNFG   0x020
#define I2C_I2C_SL_RCVD   0x024
#define I2C_I2C_SL_STATUS 0x028
#define I2C_I2C_SL_STATUS_SL_IRQ (1 << 3)
#define I2C_I2C_SL_STATUS_RNW    (1 << 1)

#define I2C_I2C_SL_ADDR1  0x02c
#define I2C_I2C_SL_ADDR2  0x030
#define I2C_I2C_SL_DELAY_COUNT 0x03c
#define I2C_I2C_TX_PACKET_FIFO 0x050
#define I2C_I2C_RX_FIFO      0x054
#define I2C_PACKET_TRANSFER_STATUS 0x058
#define I2C_FIFO_CONTROL     0x05c
#define I2C_FIFO_STATUS      0x060
#define I2C_INTERRUPT_MASK   0x064
#define I2C_INTERRUPT_STATUS 0x068
#define I2C_I2C_CLK_DIVISOR  0x06c
...
#define P(i2c_dev, reg) pr_err("!!! %30s[0x%03x]: 0x%x\n", \
							   #reg, reg, i2c_readl(i2c_dev, reg));

static void dump_i2c_regs(struct tegra_i2c_dev *i2c_dev)
{
	P(i2c_dev, I2C_I2C_CNFG);
	P(i2c_dev, I2C_I2C_CMD_ADDR0);
	P(i2c_dev, I2C_I2C_CMD_ADDR1);
	P(i2c_dev, I2C_I2C_CMD_DATA1);
	P(i2c_dev, I2C_I2C_CMD_DATA2);
	P(i2c_dev, I2C_I2C_STATUS);
	if (i2c_dev->is_slave) {
		P(i2c_dev, I2C_I2C_SL_CNFG);
		P(i2c_dev, I2C_I2C_SL_RCVD);
		P(i2c_dev, I2C_I2C_SL_STATUS);
		P(i2c_dev, I2C_I2C_SL_ADDR1);
		P(i2c_dev, I2C_I2C_SL_ADDR2);
		P(i2c_dev, I2C_I2C_SL_DELAY_COUNT);
	}
//	P(i2c_dev, I2C_I2C_TX_PACKET_FIFO);
//	P(i2c_dev, I2C_I2C_RX_FIFO);
	P(i2c_dev, I2C_PACKET_TRANSFER_STATUS);
	P(i2c_dev, I2C_FIFO_CONTROL);
	P(i2c_dev, I2C_FIFO_STATUS);
	P(i2c_dev, I2C_INTERRUPT_MASK);
	P(i2c_dev, I2C_INTERRUPT_STATUS);
	P(i2c_dev, I2C_I2C_CLK_DIVISOR);
}
...
err:
	dev_warn(i2c_dev->dev, "tegra_i2c_isr: error occurred. dumping regs");
	dump_i2c_regs(i2c_dev);
	...
	struct i2c_msg *msg, int stop)
{
	...
	pr_err("tegra_i2c_xfer_msg: error: 0x%x dumping stack\n",
		   i2c_dev->msg_err);
	dump_stack();
	...
	if (i2c_dev->msg_err == I2C_ERR_ARBITRATION_LOST && i2c_bus->adapter.nr == 0) {
		...
		gpio_request(TEGRA_GPIO_PS1,"recover_trigger");
